document.addEventListener('DOMContentLoaded', () => {
    ...
    const similarResultsContainer = document.getElementById('similar-results-container');
  ...
  loadWishlistFromStorage();
    ...
    const displaySearchResults = (results, isWishlistItem) => {
      ...
      results.forEach((photo) => {
        ...
        if(cnt==1)
         searchResultsContainer.appendChild(imageCard);
        else imageContainer.appendChild(imageCard);
      });
